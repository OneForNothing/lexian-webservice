...
public class GoodsService {
    ...
    public List<Goods> findGoodsBySubType(String sub_id) {
        return goodsDao.findGoodsBySubType(sub_id);
    }
        ...
        if(!u_id.equals("-1")) { //用户已登录
            ...
            if(g_sub_idList != null || g_sub_idList.size() == 0) { //用户有收藏过商品
                ...
                if(goodsList.size()>10) {
                    ...
                    for (int i=0; i<len; i++) {
                        goodsList.add(mostHotGoodsList.get(i));
                    }
                    return goodsList;
                }
